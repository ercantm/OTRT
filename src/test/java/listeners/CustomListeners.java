...
public class CustomListeners extends Page implements ITestListener, ISuiteListener {
	...
	public void onTestStart(ITestResult result) {
		...
		test.log(LogStatus.INFO, result.getName().toUpperCase()
				+ "   checking  test  case run mode. if run mode is no: test will be skipped.");
		Reporter.log(result.getName().toUpperCase()
				+ "   checking  test  case run mode. if run mode is no: test will be skipped.");
	}
	...
	public void onTestFailure(ITestResult result) {
		System.setProperty("org.uncommons.reportng.eacape-out", "false");// this help to show htm code in index,htm
																			// report
		try {
		...
		test.log(LogStatus.SKIP, result.getName().toUpperCase() + "   Failled with this exception:   "
				+ result.getThrowable().toString().trim());
